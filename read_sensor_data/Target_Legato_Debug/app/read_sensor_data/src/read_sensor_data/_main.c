...
// Startup code for the executable 'read_sensor_data'.
...
LE_SHARED le_log_SessionRef_t read_sensor_data_exe_LogSession;
LE_SHARED le_log_Level_t* read_sensor_data_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    read_sensor_data_exe_LogSession = log_RegComponent("read_sensor_data_exe", &read_sensor_data_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_read_sensor_dataComponent.so");
