...
// Startup code for the executable 'test_gnss'.
...
LE_SHARED const char* _test_gnssComponent_le_posCtrl_ServiceInstanceName = "test_gnss.test_gnssComponent.le_posCtrl";
LE_SHARED const char* _test_gnssComponent_le_pos_ServiceInstanceName = "test_gnss.test_gnssComponent.le_pos";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t test_gnss_exe_LogSession;
LE_SHARED le_log_Level_t* test_gnss_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    test_gnss_exe_LogSession = log_RegComponent("test_gnss_exe", &test_gnss_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_test_gnssComponent.so");
