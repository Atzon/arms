...
// Startup code for the executable 'test_main'.
...
LE_SHARED const char* _test_mainComponent_le_mdc_ServiceInstanceName = "test_main.test_mainComponent.le_mdc";
LE_SHARED const char* _test_mainComponent_le_data_ServiceInstanceName = "test_main.test_mainComponent.le_data";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t test_main_exe_LogSession;
LE_SHARED le_log_Level_t* test_main_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    test_main_exe_LogSession = log_RegComponent("test_main_exe", &test_main_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_test_mainComponent.so");
