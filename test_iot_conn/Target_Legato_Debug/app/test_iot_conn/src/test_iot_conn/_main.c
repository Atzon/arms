...
// Startup code for the executable 'test_iot_conn'.
...
LE_SHARED const char* _test_iot_connComponent_le_mrc_ServiceInstanceName = "test_iot_conn.test_iot_connComponent.le_mrc";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t test_iot_conn_exe_LogSession;
LE_SHARED le_log_Level_t* test_iot_conn_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    test_iot_conn_exe_LogSession = log_RegComponent("test_iot_conn_exe", &test_iot_conn_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_test_iot_connComponent.so");
