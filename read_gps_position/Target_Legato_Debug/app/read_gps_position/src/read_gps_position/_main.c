...
// Startup code for the executable 'read_gps_position'.
...
LE_SHARED const char* _read_gps_positionComponent_le_posCtrl_ServiceInstanceName = "read_gps_position.read_gps_positionComponent.le_posCtrl";
LE_SHARED const char* _read_gps_positionComponent_le_pos_ServiceInstanceName = "read_gps_position.read_gps_positionComponent.le_pos";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t read_gps_position_exe_LogSession;
LE_SHARED le_log_Level_t* read_gps_position_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    read_gps_position_exe_LogSession = log_RegComponent("read_gps_position_exe", &read_gps_position_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_read_gps_positionComponent.so");
