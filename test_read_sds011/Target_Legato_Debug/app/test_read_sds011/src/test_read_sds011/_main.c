...
// Startup code for the executable 'test_read_sds011'.
...
LE_SHARED le_log_SessionRef_t test_read_sds011_exe_LogSession;
LE_SHARED le_log_Level_t* test_read_sds011_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    test_read_sds011_exe_LogSession = log_RegComponent("test_read_sds011_exe", &test_read_sds011_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_test_read_sds011Component.so");
