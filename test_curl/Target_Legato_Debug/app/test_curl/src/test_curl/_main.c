...
// Startup code for the executable 'test_curl'.
...
LE_SHARED le_log_SessionRef_t test_curl_exe_LogSession;
LE_SHARED le_log_Level_t* test_curl_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    test_curl_exe_LogSession = log_RegComponent("test_curl_exe", &test_curl_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_test_curlComponent.so");
